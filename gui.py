...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.toolTitel, 1, 10, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.toolUeberschrift, 1, 11, 1, 1)
        self.toolAlignCenter = QtWidgets.QToolButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.toolAlignCenter.setFont(font)
        self.toolAlignCenter.setCheckable(False)
        self.toolAlignCenter.setObjectName("toolAlignCenter")
        self.gridLayout_2.addWidget(self.toolAlignCenter, 1, 5, 1, 1)
...
"}                                        ")
        ...
        self.gridLayout_2.addLayout(self.layoutTabs, 0, 0, 1, 12)
        self.toolAlignLeft = QtWidgets.QToolButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.toolAlignLeft.setFont(font)
        self.toolAlignLeft.setCheckable(False)
        self.toolAlignLeft.setObjectName("toolAlignLeft")
        self.gridLayout_2.addWidget(self.toolAlignLeft, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.textEdit, 2, 0, 1, 12)
        ...
        self.gridLayout_2.addWidget(self.toolStandard, 1, 9, 1, 1)
        self.toolFont = QtWidgets.QFontComboBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.toolFont.setFont(font)
        self.toolFont.setObjectName("toolFont")
        self.gridLayout_2.addWidget(self.toolFont, 1, 7, 1, 1)
        self.toolAlignRight = QtWidgets.QToolButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.toolAlignRight.setFont(font)
        self.toolAlignRight.setCheckable(False)
        self.toolAlignRight.setObjectName("toolAlignRight")
        self.gridLayout_2.addWidget(self.toolAlignRight, 1, 6, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSaveAs.setText(_translate("MainWindow", "Datei speichern als"))
